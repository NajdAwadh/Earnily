...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(name +' ' + family ,style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600),),
                SizedBox(height: 5,),
                Text(email,style: TextStyle(fontSize: 13.0,fontWeight: FontWeight.w300),),
                SizedBox(height: 20,),
                // GestureDetector(
                //   onTap: (){
                //     isEnabled =! isEnabled;
                ...
                SizedBox(height: 20,),
                NewText(text: ':الاسم الاول' , fontWeight: FontWeight.bold, size: 18,),
                CustomTextField(controller: nameController, hint: name, isEnabled: isEnabled),
                SizedBox(height: 10,),
                NewText(text: ':العائلة' , fontWeight: FontWeight.bold, size: 18,),
                CustomTextField(controller: _familyController, hint: family, isEnabled: isEnabled),
                SizedBox(height: 10,),
                NewText(text: ':البريد الإلكتروني' , fontWeight: FontWeight.bold, size: 18,),
                CustomTextField(controller: _emailController, hint: email, isEnabled: isEnabled),
                if(isEnabled == false)
                NewButton(text: 'تعديل', 
                height: 100,
                width: 320,
                onClick: (){
                  isEnabled =! isEnabled;
  ...
  try{
    FirebaseFirestore.instance
      ...
      "family": _familyController.text.isEmpty?family:_familyController.text,
